...
class CouponsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'coupon_percentage' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'created_for' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2022-04-02 09:13:14',
                'modified' => '2022-04-02 09:13:14',
            ],
        ];
        parent::init();
    }
