...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'mobile' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'status' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '0 => Not activated , 1 => Activated', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_by' => 1,
                'status' => 1,
                'created' => '2022-02-25 04:36:18',
                'modified' => '2022-02-25 04:36:18',
            ],
        ];
        parent::init();
    }
