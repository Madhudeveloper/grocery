...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/account', ['controller' => 'Pages', 'action' => 'account']);
    $routes->connect('/privacy-policy', ['controller' => 'Pages', 'action' => 'privacyPolicy']);
    $routes->connect('/terms-conditions', ['controller' => 'Pages', 'action' => 'termsConditions']);
    $routes->connect('/login', ['controller' => 'Pages', 'action' => 'login']);
    $routes->connect('/contact-us', ['controller' => 'Pages', 'action' => 'contactUs']);
    $routes->connect('/invoice', ['controller' => 'Pages', 'action' => 'invoice']);
