                            ...
                            <div class="card-block">
                                <?= $this->Form->create($productVariant,['novalidate' => true ]) ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <?php echo $this->Form->control('uom_id',[ 'class' => 'select2 form-control mb-3 custom-select' , 'label' => false , 'options' => $uoms ]); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <?php echo $this->Form->control('offer_percentage',['class' => 'form-control', 'label' => false]); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Gst Percentage</label>
                                        <div class="col-sm-8">
                                            <?php echo $this->Form->control('gst_percentage',['class' => 'form-control', 'label' => false]); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
