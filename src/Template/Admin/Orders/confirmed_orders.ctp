                                    ...
                                    <tbody>
                                        ...
                                        <tr style="background-color: #fff;">
                                            ...
                                            <td class="text-center">
                                                <select class="form-control" style="height: 18px; width: 100px;" order-id="<?php echo $order['id']; ?>">
...
<script type="text/javascript">
    ...
    /** Submit Shipment **/
    $(document).on('click', '.submit_shipment', function(){
        ...
        $.ajax({
            type: "POST";
            Url: '<?php echo $this->Url->build('/admin/orders/submitShipment'); ?>',
            dataType: "json",
            data: {order_id:$('.order-id').val(),courier_name:$('.courier_name').val(), bill_number:$('.bill_number').va;()},
            success: function(data)
            {
               $('#WaybillForm').modal('toggle');
            },
            error:function(){}
