                                ...
                                <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Shippment detail</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="background-color: #fff;">
                                           ...
                                           <td class="text-center">
                                            ...
                                            <td>
                                                <?php  if(!empty($order['order_invoices'][0]['courier_name'])){ echo $order['order_invoices'][0]['courier_name']." / ".$order['order_invoices'][0]['bill_number']; } ?>
                                            </td>
                                            <td class="text-center">
                                                <div class="btn-group">
