                                ...
                                <div class="card-block">
                                    <?= $this->Form->create($coupon,['novalidate' => true ]) ?>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <?php echo $this->Form->control('code',[ 'placeholder' => 'Coupon name' , 'class' => 'form-control' , 'label' => false]); ?>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Is Active</label>
                                            <div class="col-sm-8">
                                                 <?php echo $this->Form->control('is_active',['class' => 'form-control' , 'label' => false]); ?>
                                            </div>
                                        </div>
                                        <div class="form-group row">
