                                ...
                                <div class="col-lg-9">
                                    <div class="single-page pr-30 mb-lg-0 mb-sm-5">
                                        ...
                                        <div class="single-content mb-50">
                                            ...
                                            <ol start="25">
                                                <li>If you have any questions about our privacy practices or the way in which we have been managing your personal information, please contact our privacy champion in writing at PO Box 16122 Collins Street West Victoria 8007 Australia or <a href="/cdn-cgi/l/email-protection#bbcbc9d2cddad8c295d8d3dad6cbd2d4d5fbfad7d2efd3ded6dec895d8d4d6"><span class="__cf_email__" data-cfemail="fc8c8e958a9d9f85d29f949d918c959392bcbd9095a8949991998fd29f9391">[email&#160;protected]</span></a>.</li>
                                    ...
                                    <div class="widget-area">
                                        ...
                                        <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                                            ...
                                            <div class="single-post clearfix">
                                                <div class="image">
                                                    <img src="<?php echo $this->Url->build('/frontend/demo/assets/imgs/shop/thumbnail-3.jpg'); ?>" alt="#" />
                                                </div>
                                            ...
                                            <div class="single-post clearfix">
                                                <div class="image">
                                                    <img src="<?php echo $this->Url->build('/frontend/demo/assets/imgs/shop/thumbnail-4.jpg'); ?>" alt="#" />
                                                </div>
                                                <div class="content pt-10">
                                            ...
                                            <div class="single-post clearfix">
                                                <div class="image">
                                                    <img src="<?php echo $this->Url->build('/frontend/demo/assets/imgs/shop/thumbnail-5.jpg'); ?>" alt="#" />
                                                </div>
                                                <div class="content pt-10">
                                            ...
                                            <div class="single-post clearfix">
                                                <div class="image">
                                                    <img src="<?php echo $this->Url->build('/frontend/demo/assets/imgs/shop/thumbnail-6.jpg'); ?>" alt="#" />
                                                </div>
                                                <div class="content pt-10">
                                        ...
                                        <div class="banner-img wow fadeIn mb-40 animated d-lg-block d-none">
                                            <img src="<?php echo $this->Url->build('/frontend/demo/assets/imgs/banner/banner-11.png'); ?>" alt="" />
