                ...
                <div class="container">
                    <div class="archive-header">
                        <div class="row align-items-center">
                            <div class="col-xl-3">
                                <h1 class="mb-15"><?php echo $category['name']; ?></h1>
                                <div class="breadcrumb">
                                    <a href="<?php echo $this->Url->build('/'); ?>" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a><span></span>Category<!-- <span></span><?php echo $category['product_name']; ?> -->
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row flex-row-reverse">
                    <div class="col-lg-4-5">
                        <div class="row product-grid">
                            <?php foreach ($products as $key => $new_product){?>
                    ...
                    <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <?php foreach ($toprated_products as $key => $toprated_products) { ?>
                                <?php $getreview = 0; $total = 0; foreach($toprated_products['reviews'] as $key => $review) { 
                                    $total += $review['rating'];
                                    $totalreview = count($toprated_products['reviews']);
                                    $getreview = ($total/$totalreview)*20;
                                }?> 
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="<?php echo $this->Url->build('/webroot/uploads/products/'.$toprated_products['image_2']); ?>" alt="#" />
                                </div>
                                <div class="content pt-10">
                                    <h5><a href="<?php echo $this->Url->build('/products/view/'.$toprated_products['slug']); ?>"><?php echo $toprated_products['product_name']; ?></a></h5>
                                    <p class="price mb-0 mt-5">₹ <?php echo $toprated_products['product_variants']['0']['price'] ?></p>
